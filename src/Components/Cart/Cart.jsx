...
const Cart = ({ data }) => {
    ...
    const price = count * data[0].price;
    return (
                        ...
                        data?.map((item, index) => (
                            <Fragment>
                                <div className="cart__left-bottom" key={index}>
                                    <div className="cart__left-content">
                                        ...
                                        <div className="cart__left-wrapper">
                                            ...
                                            <div className="cart__left-counter">
                                ...
                                <div className="cart__discount">
                                    <input className='cart__discount-input' type="text" placeholder='Рекламный код' />
                                    <button className='cart__discount-button'>Применить</button>
                                </div>
                            </Fragment>
                        ))
                    }
                </div>
                {isSmallMobile ? <CartBottom price={price} /> : <CartRight price={price} />}
            </div>
        </section>
    )
}
